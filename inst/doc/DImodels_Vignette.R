...
#  theta_CI(auto1$selected_model_obj, conf = .95)
...
## ---- echo = TRUE-------------------------------------------------------------
  m3 <- DI(y = "response", prop = 4:12, 
           ...
           extra_formula = ~ (bfg_FG1_FG2 + bfg_FG1_FG3 + bfg_FG2_FG3 + wfg_FG1 + wfg_FG2 
...
## ---- echo = TRUE-------------------------------------------------------------
m3 <- DI(y = "response", custom_formula = response ~ 0 + p1 + p2 + p3 + p4 + p5 + p6 + p7 + p8 + p9 
